...
output2 = word1[0:4] + '-' + word2[-4:len(word2)] # str: join first four letters of word1 and last four letters of word 2 with a hyphen "-" in between
...
ends_with_a = "a" == word1[len(word1)-1] or "A" == word1[len(word1)-1] # bool: True if word1 ends with letter a or A
